...
<html>
  ...
  <body>
    <div class="testbox">
      <form action="/Admin-storecourse" method="post">
      @csrf
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4"></h1>
    <p class="lead">you can update or add courses here</p>
  </div>
        <div class="item">
          <p>Course title</p>
          <div class="name-item">
        ...
        <div class="contact-item">
          <div class="item">
            <p>fees</p>
            <input type="text" required name="fees"/>
          </div>
        ...
        <div class="item">
          ...
          <textarea rows="3" required name="desc"></textarea>
        </div>
        <div class="item">
          <p>Course Duration</p>
